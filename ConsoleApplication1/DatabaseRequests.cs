...
public class DatabaseRequests
{
    ...
    public static void AddUserInTable(string login, string password)
    {
        ...
        cmd.ExecuteNonQuery();
        Console.WriteLine("Вы были зарегистрированы.");
    }
    ...
    public static string[] CheckUser()
    {
        ...
        string[] paramsUser = new string[2]; 
        while (reader.Read())
        {
            ...
            if (reader[1].ToString() == login) //занят ли такой логин
            {
                Console.WriteLine("Такой логин уже был добавлен.");
            }
            else if(reader[2].ToString() == password) //занят ли такой пароль
            {
                Console.WriteLine("Такой пароль уже был добавлен.");
            }
            else
            {
                paramsUser[0] = login;
    ...
    public static void GetAllTasksTable(int id)
    {
        ...
        while (reader.Read())
        {
            if (int.Parse(reader[4].ToString()) == id) 
            {
